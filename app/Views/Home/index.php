...
<div class="container section" id="menu" data-aos="fade-up" style="margin-top: 3em">
    <div class="title-block">
        <h1 class="section-title">Clique no item para adicionar ao carrinho</h1>
    </div>
        ...
        <div class="row">
            ...
            <?php else: ?>
                <?php foreach ($produtos as $produto): ?>
                    <div class="col-sm-6 filtr-item image filter active todas <?php echo $produto->categoria_slug; ?>">
