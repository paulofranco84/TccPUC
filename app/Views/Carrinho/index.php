            ...
            <div class="row">
                <?php if (!isset($carrinho)): ?>
                    <div class="text-center">
                        ...
                        <a href="<?php echo site_url("/"); ?>" class="btn btn-lg" style="background-color: #990100; color: white; margin-top: 2em">Mais produtos</a>
                    </div>
                <?php else: ?>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($carrinho as $produto): ?>
                                    <tr>
                                        ...
                                        <td class="col-md-5"><?php echo esc($produto->nome); ?></td>
                                        <td class="col-md-2"><?php echo esc($produto->tamanho); ?></td>
                    ...
                    <div class="col-md-12">
                        ...
                        <a href="<?php echo site_url("/"); ?>" class="btn btn-primary" style="font-family: 'Montserrat-Bold';">Mais produtos</a>
