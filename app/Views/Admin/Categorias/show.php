      ...
      <div class="col-lg-6 grid-margin stretch-card">
          <div class="card">
              ...
              <div class="card-footer bg-white">
                <?php if ($categoria->deletado_em == null): ?>
                    <a href="<?php echo site_url("admin/categorias/editar/$categoria->id"); ?>" class="btn btn-dark btn-icon-text text-white btn-sm mr-2">
                        <i class="mdi mdi-pencil"></i> Editar
                    </a>

                    <a href="<?php echo site_url("admin/categorias/excluir/$categoria->id"); ?>" class="btn btn-danger btn-icon-text text-white btn-sm mr-2">
                        <i class="mdi mdi-delete"></i> Excluir
                    </a>

                    <a href="<?php echo site_url("admin/categorias"); ?>" class="btn btn-light btn-icon-text btn-sm text-dark mr-2">
