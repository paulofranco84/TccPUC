                ...
                <ul class="list-arrow">
                    ...
                    <?php else: ?>
                        <?php foreach ($produtosMaisVendidos as $produto): ?>
                            <li class="mb-2">
                                <?php echo word_limiter($produto->produto, 25); ?>
                    ...
                    <?php else: ?>
                        <?php foreach ($entregadoresMaisAssiduos as $entregador): ?>
                            <li class="mb-2">
                                ...
                                <?php else: ?>
                                    <img class="rounded-circle" width="40" src="<?php echo site_url('admin/images/entregador-sem-imagem.jpg'); ?>" alt="Entregador sem imagem"/>
                                <?php endif; ?>
...
<script>
    setInterval("atualiza();", 30000); // 30.000 milisegundos =  30 segundos
    function atualiza() {
