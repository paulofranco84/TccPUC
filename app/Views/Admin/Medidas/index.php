      ...
      <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div>
                        <a href="<?php echo site_url("admin/medidas/criar"); ?>" class="btn btn-success m-1">
                    ...
                    <div class="table-responsive">
                      <table id="tabela_medidas" class="table table-hover">
                        <thead>
                          <tr>
                            <th>Nome</th>
                        ...
                        <tbody>
                          <?php foreach ($medidas as $medida) : ?>
                              <tr>
                                  <td><a href="<?php echo site_url("admin/medidas/show/$medida->id"); ?>"><?php echo $medida->nome; ?></a></td>
...
<script>
    $("#btn_csv").click(function(){
        $("#tabela_medidas").tableHTMLExport({
            type:'csv',
    ...
    $("#btn_pdf").click(function(){
        ...
        pdf.html(document.getElementById('tabela_medidas'), {
