    ...
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mt-4">
                    <a href="<?php echo site_url("admin/pedidos/editar/$pedido->codigo"); ?>" class="btn btn-dark btn-sm m-1">
                        <i class="mdi mdi-pencil btn-icon-prepend"></i>
                        Alterar situação
                    </a>

                    <a href="<?php echo site_url("admin/pedidos/excluir/$pedido->codigo"); ?>" class="btn btn-danger btn-sm m-1">
                        <i class="mdi mdi-trash-can btn-icon-prepend"></i>
                        Excluir pedido
                    </a>

                    <a href="<?php echo site_url("admin/pedidos"); ?>" class="btn btn-light text-dark btn-sm m-1">
