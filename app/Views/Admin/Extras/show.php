          ...
          <div class="card">
              ...
              <div class="card-body">
                  ...
                  <p class="card-text">
                      ...
                      R$&nbsp<?php echo esc(number_format($extra->preco,2)); ?>
                  </p>
              ...
              <div class="card-footer bg-white">
                <?php if ($extra->deletado_em == null): ?>
                    <a href="<?php echo site_url("Admin/Extras/editar/$extra->id"); ?>" class="btn btn-dark btn-icon-text text-white btn-sm mr-2">
                        <i class="mdi mdi-pencil"></i> Editar
                    </a>

                    <a href="<?php echo site_url("Admin/Extras/excluir/$extra->id"); ?>" class="btn btn-danger btn-icon-text text-white btn-sm mr-2">
                        <i class="mdi mdi-delete"></i> Excluir
                    </a>

                    <a href="<?php echo site_url("Admin/Extras"); ?>" class="btn btn-light btn-icon-text btn-sm text-dark mr-2">
