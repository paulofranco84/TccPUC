      ...
      <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div>
                        <a href="<?php echo site_url("Admin/Extras/criar"); ?>" class="btn btn-success m-1">
                    ...
                    <div class="table-responsive">
                      <table id="tabela_extras" class="table table-hover">
                        <thead>
                          <tr>
                            <th>Nome</th>
                            <th>Preço</th>
                        ...
                        <tbody>
                          <?php foreach ($extras as $extra) : ?>
                              <tr>
                                  <td><a href="<?php echo site_url("Admin/Extras/show/$extra->id"); ?>"><?php echo $extra->nome; ?></a></td>
...
<script> 
    ...
    $("#btn_pdf").click(function(){
        ...
        pdf.html(document.getElementById('tabela_extras'), {
