...
<body>
    ...
    <div class="container-fluid page-body-wrapper">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('admin/FormasPagamento'); ?>">
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">TCC - PUC Minas Virtual</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Paulo Henrique Zuliani Franco</span>
          </div>
        </footer>
      </div>
    </div>
  ...
  <script src="<?php echo site_url('admin/'); ?>js/tableHTMLExport.js"></script>
  <script src="<?php echo site_url('admin/'); ?>js/jspdf.plugin.autotable.js"></script>
