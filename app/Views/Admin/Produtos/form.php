<div class="form-row">
    ...
    <div class="form-group col-md-12">
        ...
        <textarea class="form-control" rows="3" id="ingredientes" name="ingredientes"><?php echo old('ingredientes', esc($produto->ingredientes)); ?></textarea> 
    </div>
...
<div class="form-check form-check-flat form-check-primary mb-2">
    <label for="ativo" class="form-check-label">
        ...
        <input type="checkbox" class="form-check-input" id="ativo" name="ativo" value="1" <?php if (old('ativo', $produto->ativo)) : ?> checked="" <?php endif; ?>> Ativo
    </label>
</div>