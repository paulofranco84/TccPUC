    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label>Escolha a medida do produto <a href="javascript:void" class="" data-toggle="popover" title="Medida do produto" data-content="Exemplo de uso para pizza: <br>Pizza Grande, <br>Pizza Média, <br>Pizza Família...">Entenda</a></label>
                    ...
                    <div class="form-group col-md-4">
                        <label>Produto Customizavel <a href="javascript:void" class="" data-toggle="popover" title="Produto meio a meio" data-content="Exemplo de uso para pizza: <br>Metade calabresa e metade bacon com batata palha">Entenda</a></label>
            ...
            <div class="card-footer bg-white">
                    <button type="submit" class="btn btn-primary text-white mr-2 btn-sm mt-4">
                        <i class="mdi mdi-checkbox-marked-circle btn-icon-prepend"></i> Inserir especificação
                    </button>
                <?php echo form_close(); ?>

                <a href="<?php echo site_url("admin/produtos/show/$produto->id"); ?>" class="btn btn-light btn-sm text-dark mt-4">
                ...
                <div class="form-row">
                    <div class="col-md-8">
                        <?php if (empty($produtoEspecificacoes)) : ?>
                            ...
                            <p>Esse produto não possui especificações até o momento. Portanto ele <strong>não será exibido</strong> como opção de compra na area pública<p>
