...
class Filters extends BaseConfig
{
    ...
    public $filters = [
        'login' => [
            'before' => [
                'admin/*', //todos os controllers que estão detro do namespace admin só serão acessados após o login
            ]
        ],
        'admin' => [
            'before' => [
                'admin/*', //todos os controllers que estão detro do namespace admin só serão acessados por um adminstrador
            ]
        ],
    ];
}
