...
class FormasPagamento extends BaseController {
    ...
    public function cadastrar() {
        if ($this->request->getMethod() === 'post') {
            ...
            if ($this->formaPagamentoModel->save($formaPagamento)) {
                return redirect()->to(site_url("admin/FormasPagamento/show/" . $this->formaPagamentoModel->getInsertID()))
    ...
    public function atualizar($id = null) {
        if ($this->request->getMethod() === 'post') {
            ...
            if ($this->formaPagamentoModel->save($formaPagamento)) {
                return redirect()->to(site_url("admin/FormasPagamento/show/$formaPagamento->id"))
    ...
    public function excluir($id = null) {
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            return redirect()->to(site_url('admin/FormasPagamento'))->with('sucesso', "Forma de pagamento $formaPagamento->nome excluída com sucesso!");
        }
